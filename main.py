...
if cookie:
    cursor = None
    for _ in range(5):  # max 500 assets (5×100)
    ...
    # Fetch the most recent 30 audios uploaded to the group
    cursor = None
    for _ in range(3):
        params = {
            "category":          "Audio",
        ...
        # Use asset multiget for creator info
...
if api_key:
    async with httpx.AsyncClient(timeout=15) as c:
        # Try v2 archive operation first
        r = await c.post(
